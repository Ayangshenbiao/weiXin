<?php 
	...
	$jssdk = new JSSDK("wx27e2a6b55a85bed6", "dddfa4842b2690e8cec7c5559d3d56ab");
	...
	$appsecret = "dddfa4842b2690e8cec7c5559d3d56ab";
...
//			touch.on( "body", "touchend", "#menu3", function(ev){
			...
			function countTime(){
				...
				timer=setInterval(function(){
					...
					if(allTime<=0){
						...
						$.ajax({
							type:"get",
							url:"http://yuweihai.applinzi.com/countMoney/submit.php",
							data:{
			...
			wx.onMenuShareAppMessage({
			    title: '数钱游戏', // 分享标题
			    desc: '由于是测试号要先关注在点击链接', // 分享描述
			    link: 'http://1.yuweihai.applinzi.com/webchat/access.html', // 分享链接
			    imgUrl: 'http://img1.imgtn.bdimg.com/it/u=2460612982,3793696981&fm=21&gp=0.jpg', // 分享图标
